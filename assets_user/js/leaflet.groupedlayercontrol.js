...
L.Control.GroupedLayers = L.Control.extend({
    ...
    _initLayout: function() {
        ...
        this._baseLayersGroup = L.DomUtil.create('div', className + '-base-group', form);
        this._baseLayersGroup.innerHTML = "<strong>Basemaps</strong>";
    ...
    _addItem: function(obj) {
        var label = document.createElement('label'),
            ...
            container,
            groupRadioName;
        label.className = 'leaflet-control-layers-list-label';
