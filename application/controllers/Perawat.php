...
class Perawat extends CI_Controller {
    ...
    public function kontrolperawat()
    {
        ...
        // var_dump( $data['name']);
        // die;
        $data['title'] = 'Input Kontrol Pasien';
        $this->load->view('templates/user/header', $data); 
		$this->load->view('templates/user/navbar', $data); 	
        $this->load->view('templates/user/left_menu', $data);
        $this->load->view('perawat/inputkontrolpasien', $data);
        $this->load->view('templates/user/footer', $data);
    }

    public function aktivitasperawat()
    {
        ...
        // var_dump( $data['name']);
        // die;
        $data['title'] = 'Input Aktivitas Pasien';
        $this->load->view('templates/user/header', $data); 
		$this->load->view('templates/user/navbar', $data); 	
        $this->load->view('templates/user/left_menu', $data);
        $this->load->view('perawat/inputaktivitas', $data);
        $this->load->view('templates/user/footer', $data);
    }
    ...
    public function inputobat()
    {
        ...
        // var_dump( $data['name']);
        // die;
        $data['title'] = 'Input Obat Pasien';
        $this->load->view('templates/user/header', $data); 
		$this->load->view('templates/user/navbar', $data); 	
        $this->load->view('templates/user/left_menu', $data);
        $this->load->view('perawat/inputobat', $data);
        $this->load->view('templates/user/footer', $data);
    }
}