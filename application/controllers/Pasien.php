...
class Pasien extends CI_Controller {
    ...
    public function index()
	{
        ...
        $data['menu_diet']=$this->db->query("SELECT * FROM diet_nutrisionist NATURAL JOIN m_patient WHERE id_patient=$season_patient ORDER BY id_diet_nutrisionist DESC LIMIT 1")->row_array();
