            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Buat Resep untuk pasien : <?=$data['name_patient']?></h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="" class="needs-validation"
                            ...
                            <input type="text" name="id_patient" name="id_patient" class="form-control" hidden disable required autofocus tabindex="1" value="<?= $data['id_patient']?>">
