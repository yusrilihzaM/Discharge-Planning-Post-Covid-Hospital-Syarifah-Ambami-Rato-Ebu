                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="<?= base_url() ?>assets/img/rslogo.png" alt="logo" width="100"
                                class="shadow-light ">
                        </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <?= $this->session->flashdata('message'); ?>
                                <form method="POST" action="<?= base_url('worker'); ?>" class="needs-validation" novalidate="">
                        ...
                        <div class="simple-footer">
                            Copyright &copy;Universitas Trunojoyo Madura 2021
                        </div>
                    </div>
                </div>
            </div>
