...
<main id="main">
    ...
    <section id="deteksi" class="contact mt-3" style="background-color:white;">
        <div class="container-fluid">
            <div class="flash-data-warning" data-flashdata="<?= $this->session->flashdata('warning') ?>">

            </div>
            <div class="flash-data-peringatan" data-flashdata="<?= $this->session->flashdata('peringatan') ?>">
            </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class=" row  d-flex justify-content-center">
                            <div class="col-sm-5 form-group">
                                ...
                                NIK
                                <input type="text" class="form-control p-4 mx-auto" name="nik" id="NIK"
                                    style="background-color:#eeeeee;" placeholder="Masukan NIK" required>
                                <div class="invalid-feedback">
                                    Silakan isi NIK anda
                                </div>
                            </div>

                            <div class="col-sm-3 form-group d-flex justify-content-center">
                                <button type="submit" class="btn btn-primary mt-4" style="height: 60%;">Mulai Deteksi
                                    Mandiri</button>
                            </div>
                        </div>
                    </form>
...
<!-- JS Libraies -->
<script src="<?= base_url() ?>node_m_userodules/jquery-sparkline/jquery.sparkline.min.js"></script>
<script src="<?= base_url() ?>node_m_userodules/chart.js/dist/Chart.min.js"></script>
<script src="<?= base_url() ?>node_m_userodules/owl.carousel/dist/owl.carousel.min.js"></script>
<script src="<?= base_url() ?>node_m_userodules/summernote/dist/summernote-bs4.js"></script>
<script src="<?= base_url() ?>node_m_userodules/chocolat/dist/js/jquery.chocolat.min.js"></script>
